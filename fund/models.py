...
class Annee(models.Model):
    ...
    def __str__(self):
        return  self.val_annee

class Trimestre(models.Model):
    id_trim = models.AutoField(primary_key=True)
    name_trim = models.CharField(max_length=10,blank=True)
...
class Fund(models.Model):
    ...
    queue_term = models.TextField(blank=True, null=True,choices=((' ', ' '), ('1', '1990'), ('2', '1991'),('3', '1992'),('4', '1993'),('5', '1994')),default='')  # This field type is a guess.
    loan_interest = models.FloatField(blank=True, null=True)
    loan_maturity = models.TextField(blank=True, null=True,choices=((' ', ' '), ('1', '1990'), ('2', '1991'),('3', '1992'),('4', '1993'),('5', '1994')),default='')  # This field type is a guess.
